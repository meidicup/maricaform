...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const finalists = [
    ...
    { id: 'C1', name: 'するめ', group: 'C', bio: 'Cグループ一位通過' },
    { id: 'C2', name: 'Canule', group: 'C', bio: 'Cグループ二位通過' },
    { id: 'C3', name: 'ながせ', group: 'C', bio: 'Cグループ三位通過' },
    { id: 'C4', name: 'たなかたろう', group: 'C', bio: 'Cグループ四位通過' },
  ];
